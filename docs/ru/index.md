...
запуском на ноутбуке и в лаборатории NEWUU сводится к двум параметрам подключения.
...
- [x] Страницы [регистрации](registration.md) и [обучающих материалов](learn.md)
- [ ] Утверждение регламента, календаря и весов оценки
- [ ] Подставить рабочую ссылку Google Form в `docs/ru/registration.md`
